import { Language, GeneralAppSettings, TestSpecificSettings, LanguagePack, AnswerNumberingStyle, MappedAppField } from './types.js';
...
export const translations: LanguagePack = {
  [Language.LV]: {
    ...
    testProfilesHubTitle: "Testu Profili", // Added
    someProfileTitle: "Profila Nosaukums", // Added
  ...
  [Language.EN]: {
    ...
    testProfilesHubTitle: "Test Profiles", // Added
    someProfileTitle: "Profile Title", // Added
  ...
  [Language.UK]: {
    ...
    testProfilesHubTitle: "Тестові Профілі", // Added
    someProfileTitle: "Назва Профілю", // Added
    ...
    // Chatbot related
    chatbotViewTitle: "AI Помічник",
    chatbotPlaceholder: "Напишіть ваше повідомлення тут...",
    chatbotSend: "Надіслати",
    chatbotClearChat: "Очистити Чат",
    chatbotIsTyping: "AI пише...",
    chatbotErrorApi: "Не вдалося зв'язатися з AI. Будь ласка, спробуйте пізніше.",
    chatbotErrorApiKeyMissing: "Функціонал AI недоступний. Ключ API не налаштовано.",
